...
<preview-components>
  <xw-select-base slot="component"></xw-select-base>
  <<< @/docs/.vuepress/components/docsComponents/XwSelect/base.vue
</preview-components>
...
<preview-components>
  <xw-select-custom slot="component"></xw-select-custom>
  <<< @/docs/.vuepress/components/docsComponents/XwSelect/custom.vue
</preview-components>
...
<preview-components>
  <xw-select-page slot="component"></xw-select-page>
  <<< @/docs/.vuepress/components/docsComponents/XwSelect/page.vue
</preview-components>
